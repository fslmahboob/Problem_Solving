...
public class BabyNames {
    ...
    public void testgetRank(){
        ...
        int rank4 = getRank(1971, "Frank", "M");
        System.out.println("Rank4: " + rank4);
    }
    ...
    public void testgetAverageRank(){
        ...
        System.out.println("The average rank: " + avg);
    }
    ...
    public int getTotalBirthsRankedHigher(int year, String name, String gender){
        ...
        // Create StorageResource to store the births as Strings
        ...
        while (rank > 1){
            ...
            //System.out.println("Births: " + getBirths(year, rank, gender));
            // Add births for that rank in Storage Resource as a string
            sr.add(getBirths(year, rank, gender));
        }
        
        // Loop through all the Strings of births in sr
        for (String item : sr.data()){
            // Debugging Statements
            //System.out.println("Item: " + item);
            //System.out.println("sumBirths: " + sumBirths);
            // Convert each String birth to int and add it to counter
            sumBirths += Integer.parseInt(item);
        }
        return sumBirths;
    }
    
    public String getBirths(int year, int rank, String gender){
        // Initialise counters
        int countG = 0;
        int countB = 0;
        String births = "";
        ...
        for (CSVRecord row : parser){
            if (row.get(1).equals("F")){
                countG += 1;
                if (row.get(1).equals(gender) && rank == countG){
                    births = row.get(2);
                }
            } else {
                countB += 1;
                if (row.get(1).equals(gender) && rank == countB){
                    births = row.get(2);
                }
            }
        }
    ...
    public void testgetBirths(){
        String births = getBirths(2012, 5, "M");
